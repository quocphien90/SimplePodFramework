#
#  Be sure to run `pod spec lint simple-pod-framework.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/quocphien90/SimplePodFramework.git", :tag => "0.0.1" }
